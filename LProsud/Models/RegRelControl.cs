...
namespace LProsud.Models
{
    ...
    public partial class RegRelControl
    {
        ...
        public string RRCTCodTarjeta { get; set; }
        public System.DateTime RRCTFecha { get; set; }
        public System.DateTime RRCTHora { get; set; }
        public int RRCTTipo { get; set; }
    }
}
