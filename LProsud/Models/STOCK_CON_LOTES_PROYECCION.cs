...
namespace LProsud.Models
{
    ...
    public partial class STOCK_CON_LOTES_PROYECCION
    {
        ...
        public Nullable<double> Venta_Promedio_Diaria { get; set; }
        public Nullable<double> Dias_De_Inventario { get; set; }
        public Nullable<double> Stock_Actual { get; set; }
        public Nullable<System.DateTime> Fecha_De_Proceso { get; set; }
        public Nullable<double> Stock_Retenido { get; set; }
        public Nullable<double> Dias_Inventario_Retenido { get; set; }
        public Nullable<double> VentaTotalDias { get; set; }
    }
}
