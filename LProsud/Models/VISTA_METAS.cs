...
namespace LProsud.Models
{
    ...
    public partial class VISTA_METAS
    {
        ...
        public Nullable<double> REPONEDOR_INTERNO { get; set; }
        public Nullable<double> REPONEDOR_EXTERNO { get; set; }
        public Nullable<double> VENDEDOR_INTERNO { get; set; }
        public Nullable<double> MONTO_B2B { get; set; }
        public string SUCURSAL_ORIGINAL { get; set; }
        public Nullable<double> FLETE_ORIGINAL { get; set; }
        public string RUT_REPONEDOR { get; set; }
        public string NOMBRE_REPONEDOR { get; set; }
        ...
        public Nullable<double> MontoMetaCalculada { get; set; }
    }
}
