...
namespace LProsud.Models
{
    ...
    public partial class VISTA_HOJAS_RUTAS
    {
        ...
        public Nullable<double> ENTREGA_EN_DOMICILIO { get; set; }
        ...
        public Nullable<int> Rend__Contb_ { get; set; }
        public Nullable<int> Rend__Total { get; set; }
        public Nullable<int> Dias_de_Rendicion { get; set; }
        public Nullable<int> Dias_Atraso_Rendicion { get; set; }
