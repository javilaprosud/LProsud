...
namespace LProsud.Models
{
    ...
    public partial class DOCUMENTOS_ANALISIS_COSTO2
    {
        ...
        public Nullable<double> RapelMonto { get; set; }
        public Nullable<double> MermaMonto { get; set; }
        public Nullable<double> PUBLICIDADMonto { get; set; }
        public Nullable<double> DISTRIBUCIONMonto { get; set; }
        public Nullable<double> MontoCostoReponedor { get; set; }
        public Nullable<double> MontoCostoReponedorExt { get; set; }
